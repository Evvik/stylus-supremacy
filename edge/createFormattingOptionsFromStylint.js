...
const stylintOptionMap = {
  ...
  insertNewLineAroundImports: ['insertNewLineAroundImports', value => value],
  insertNewLineAroundBlocks: ['insertNewLineAroundBlocks', value => value],
  insertNewLineAroundProperties: ['insertNewLineAroundProperties', value => value],
  insertNewLineAroundOthers: ['insertNewLineAroundOthers', value => value],
  insertNewLineBetweenSelectors: ['insertNewLineBetweenSelectors', value => value],
}
